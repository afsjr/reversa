...
const AGENT_LABELS = {
  ...
  'reversa-archaeologist':  'Archaeologist — escavação',
  'reversa-detective':      'Detective — interpretação',
  'reversa-architect':      'Architect — síntese arquitetural',
  'reversa-writer':         'Writer — geração de specs',
  'reversa-reviewer':       'Reviewer — revisão e validação das specs',
...
export default async function addAgent(args) {
  ...
  if (availableAgents.length === 0) {
    console.log(chalk.hex('#ffa203')('  Todos os agentes disponíveis já estão instalados.\n'));
    return;
  }
